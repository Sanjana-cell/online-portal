<%@ Page Title="" Language="C#" MasterPageFile="~/Login.master" AutoEventWireup="true" CodeFile="IntraductionLogin.aspx.cs" Inherits="IntraductionLogin" %>
...
<asp:Label ID="Label1" runat="server" Text="Welcome to SriRama Tutorials" 
	...
	<div id="primary" class="site-content" style="width:700px">
                ...
                <div class="divclass"> 
				<a  title="Medium" href="Login.aspx"><span  class="articleRating alignright level-3"  style="width:100px">Log-In</span></a>
				</div>
                </div></div>
</body>
</html>
